...
namespace CREditor.GameProject
{
    ...
    class OpenProject
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\CREProjects\";
        ...
        private static void ReadProjectData()
        {
            if(File.Exists(_projectDataPath))
            {
                ...
                foreach(var project in projects)
                {
                    ...
                    {//C:\Users\Tester\Documents\CREProjects\NewProject1\
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.CRE\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.CRE\Screenshot.png");
        ...
        static OpenProject()
        {
            try
            {
                ...
                //_applicationDataPath = $@"{_applicationDataPath}ProjectData.xml";
